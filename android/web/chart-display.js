(function(root, factory) {
  ...
  function preview(lines) {
    ...
    return {
      ...
      changed_structure: complete && moving_positions.length > 0 ? structure(bits.map((bit, index) => bit ^ Number(STATES[lines[index]].moving)), true) : null,
      moving_positions
    };
  }
  function branchElement(branch) {
    return typeof branch === "string" && Object.prototype.hasOwnProperty.call(BRANCH_ELEMENTS, branch) ? BRANCH_ELEMENTS[branch] : null;
  }
